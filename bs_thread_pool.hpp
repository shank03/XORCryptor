...
namespace BS {
    ...
    public:
         ...
         */
        blocks(const T1 first_index_, const T2 index_after_last_, const size_t num_blocks_) : first_index(static_cast<T>(first_index_)),
    ...
    private:
        ...
        /**
         * @brief A condition_v variable used to notify worker() that a new task has become available.
         */
        std::condition_variable task_available_cv = {};

        /**
         * @brief A condition_v variable used to notify wait_for_tasks() that a tasks is done.
         */
